...
@section('content')
    ...
    <div class="relative min-h-screen md:flex">
        ...
        {{-- <div class=""> --}}
            ...
            {{-- 検索バー --}}
            <div class="conteiner mt-16 p-6 md:w-4/5 relative">

                <div class="hidden md:inline-block fixed top-6 left-64 right-6">
                        ...
                        <form action="search" method="POST">
                            ...
                            <span class="inline-block　antialiased">
                                ...
                                <button type="submit" class="py-2 px-2 rounded-md text-gray-500 absolute top-0 right-0 ">
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-6 h-6 bg-white">
                ...
                <div class="flex justify-evenly flex-wrap">
                    ...
                    {{-- @isset($shops) --}}
                        @foreach ($shops as $shop)
                            <div class="w-full md:w-52 shadow-md mb-5">
                                <div>
